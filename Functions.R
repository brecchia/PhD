# Zoology Curriculum Analysis Function
# 25 Aug 2024
# BKR

#------------------------------------
# FUNCTION: createcombos
# creates combinations of course that meet the following requirements earns atleast the number of credits needed with no extra courses including only up to the maximum number of 100 level credits
# input:
    #creditsneeded= minimum number of elective credits needed (i.e. 15 BA, 27 BS)
    #max100credits= maximum number of 100 level credits allowed (i.e. 0 BA, 6 BS)
    #courses= vector of course course prefixs and numbers (e.g. BIOL 101)
    #credits= vector of credits corresponding to each course (e.g. 4)
# output:
    #combos= dataframe with...
        #[,1]: combination number
        #[,2-maxcourses]: courses in combination
        #[,(maxcourses+1)-(maxcourses*2+1)]: corresponding credits for courses in combination
        #[,maxcourses*2+2]: adjusted sum of credits for combination (without extra 100 level credits)
#------------------------------------

createcombos <- function(creditsneeded=27,
                         max100credits=6,
...
BAcombos<-createcombos(creditsneeded=15,
                       max100credits=0)

BScombos<-createcombos(creditsneeded=27,
                       max100credits=6)
